...
const Services = () => (
  <>
    <Helmet>
      <title>Our Services | Car Wash, Ceramic Coating, PPF & More | Auto Glam Hubballi</title>
      <meta name="description" content="Explore Auto Glam's full service range: car washing, interior cleaning, paint correction, glass treatment, ceramic coating, wrapping, PPF, painting, accessories, and headlight restoration." />
    </Helmet>
