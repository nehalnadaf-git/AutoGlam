...
const Index = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Auto Glam Car Service Centre | Premium Car Detailing in Hubballi</title>
        <meta name="description" content="Auto Glam Car Service Centre in Hubballi offers expert car washing, ceramic coating, PPF, paint correction, wrapping, glass treatment, and accessories." />
      </Helmet>
      ...
      <section className="relative w-full bg-black pt-[60px] md:pt-[80px] flex justify-center">
        <div className="w-full max-w-[1920px] relative">
          ...
          <div className="absolute bottom-10 md:bottom-20 left-0 right-0 flex flex-col justify-center items-center gap-4 px-6 z-10 animate-4" style={{ animationDelay: '0.2s' }}>
            <Link to="/services" className="btn-primary shadow-[0_4px_20px_rgba(0,0,0,0.5)] !text-[11px] !px-6 !py-2.5 !md:text-[15px] !md:px-[42px] !md:py-[18px]">
              Our Services <ArrowRight className="w-[15px] h-[15px] md:w-[18px] md:h-[18px]" />
            </Link>
            <Link to="/contact" className="btn-secondary-dark bg-black/50 backdrop-blur-sm border-white/20 !text-[11px] !px-6 !py-2.5 !md:text-[15px] !md:px-[42px] !md:py-[18px]">
              Book Appointment
            </Link>
          </div>
        </div>
        ...
        <div style={{ maxWidth: "var(--container-xl)", margin: "0 auto", padding: "0 48px" }}>
          <div className="flex flex-col md:grid md:grid-cols-2 gap-10 md:gap-[var(--gap-xl)] items-start">
            ...
            <Reveal>
              ...
              <Link to="/about" className="btn-secondary-light" style={{ marginBottom: "40px", display: "inline-flex" }}>
            ...
            <Reveal delay={200} className="w-full">
              ...
              >
                <img src="/Images/Why%20choose%20Auto%20glam/Main4.png" alt="Auto Glam workshop and expert services" />
              </div>
            </Reveal>
          </div>
        </div>
        ...
        <div style={{ maxWidth: "var(--container-xl)", margin: "0 auto", padding: "0 48px" }}>
          <div className="flex flex-col md:grid md:grid-cols-[1.4fr_1fr] gap-12 md:gap-[var(--gap-xl)] items-center">
            ...
            <Reveal>
              ...
              <Link to="/about" className="btn-secondary-light">
            ...
            <Reveal delay={200} className="w-full relative">
              ...
              >
                <img src="/Images/Built%20on%20passion,%20driven%20by%20excellence/Mainv2.png" alt="Built on Passion, Driven by Excellence" className="w-full h-full object-cover" />
