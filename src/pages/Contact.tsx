...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us | Auto Glam Car Service Centre Hubballi</title>
        <meta name="description" content="Visit Auto Glam at Keshwapur, Hubballi. Call 9686363735. Open 7 days a week, 9 AM to 8 PM." />
      </Helmet>
